class Combobox1FormBuilder < ActionView::Helpers::FormBuilder
  ...
  def combobox_tag(name, options, opts= {})
     @template.content_tag(:input, :name => "q["+sanitize_to_id(name)+"]", :placeholder => "Or Double Click for Categories", :id => "wall", :type => "text", :list => opts[:list_id]) do
